...
title: "On the author"
portrait:
  src: "assets/Justin-Kiggins.jpg"
  alt: "Portrait of Justin Kiggins"
  name: "Justin Kiggins, PhD"
  role: "Founder"
---
...
These days he builds with AI tools every day &mdash; agent workflows, skills, evaluation harnesses for the messy judgment calls in between &mdash; and teaches teams to do the same. He is known for moving comfortably between the lab, the boardroom, and the codebase, and for finding clear direction in problem spaces that don't yet have a name.
